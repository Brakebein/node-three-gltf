...
export class GLTFLoader extends Loader {
	...
	load( url: string, onLoad: (gltf: GLTF) => void, onProgress?: (event: ProgressEvent) => void, onError?: (err: Error) => void ) {
	...
	parse( data: Buffer | ArrayBuffer | string, path: string, onLoad: (gltf: GLTF) => void, onError?: (err: Error) => void ) {
...
class GLTFParser {
	...
	loadTextureImage( textureIndex: number, sourceIndex: number, loader: TextureLoader ) {
	...
	loadMaterial( materialIndex: number ): Promise<Material> {
		...
		let materialType;
		const materialParams: Partial<ExcludeFunctionProps<MeshStandardMaterial>> = {};
...
function addPrimitiveAttributes( geometry: BufferGeometry, primitiveDef, parser: GLTFParser ): Promise<BufferGeometry> {
